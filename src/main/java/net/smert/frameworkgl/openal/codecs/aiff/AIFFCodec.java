package net.smert.frameworkgl.openal.codecs.aiff;
...
public class AIFFCodec implements Codec {
    ...
    private final static Logger log = LoggerFactory.getLogger(AIFFCodec.class);
    ...
    public Data load(String audioFile) throws IOException {
        log.info("Loading AIFF audio file: {}", audioFile);
