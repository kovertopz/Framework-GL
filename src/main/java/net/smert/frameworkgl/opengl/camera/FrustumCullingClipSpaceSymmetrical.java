 ...
 */
public class FrustumCullingClipSpaceSymmetrical extends AbstractFrustumCulling {

    private final Matrix4f clippingMatrix;

    public FrustumCullingClipSpaceSymmetrical() {
        clippingMatrix = new Matrix4f();
    }

    @Override
    public void updatePlanes(Matrix4f projectionMatrix, Matrix4f viewMatrix) {
        projectionMatrix.projectionSymmetricalMultiplyViewOut(viewMatrix, clippingMatrix);
