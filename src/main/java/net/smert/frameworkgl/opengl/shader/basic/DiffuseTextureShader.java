 ...
 */
public class DiffuseTextureShader extends AbstractShader {

    private final Uniforms uniforms;

    public DiffuseTextureShader(Uniforms uniforms, Shader shader) {
    ...
    public static class Factory {
        ...
        public static DiffuseTextureShader Create() throws IOException {
            Shader shader = Fw.graphics.buildShader("basic/diffuse_texture.fsh", "basic/diffuse_texture.vsh", "diffuseTexture");
            return new DiffuseTextureShader(new Uniforms(shader.getProgramID()), shader);
        }
