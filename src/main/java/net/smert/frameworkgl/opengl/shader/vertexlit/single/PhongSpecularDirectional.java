...
public class PhongSpecularDirectional extends AbstractShader {
    ...
    public PhongSpecularDirectional(PhongSpecularUniforms uniforms, Shader shader) {
    ...
    public static class Factory {
        ...
        public static PhongSpecularDirectional Create() throws IOException {
            ...
            return new PhongSpecularDirectional(new PhongSpecularUniforms(shader.getProgramID()), shader);
        }
