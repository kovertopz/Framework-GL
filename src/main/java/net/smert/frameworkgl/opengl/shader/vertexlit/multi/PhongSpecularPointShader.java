 ...
 */
public class PhongSpecularPointShader extends AbstractSpecularShader {
    ...
    public static class Factory {
        ...
        public static PhongSpecularPointShader Create() throws IOException {
            Shader shader = Fw.graphics.buildShader(
                    "vertexlit/multi/phong_specular_point.fsh",
                    "vertexlit/multi/phong_specular_point.vsh",
                    "vertexLitMultiPhongSpecularPoint");
