 ...
 */
public class BlinnPhongSpecularDirectionalShader extends AbstractSpecularShader {
    ...
    public static class Factory {
        ...
        public static BlinnPhongSpecularDirectionalShader Create() throws IOException {
            Shader shader = Fw.graphics.buildShader(
                    "vertexlit/multi/blinn_phong_specular_directional.fsh",
                    "vertexlit/multi/blinn_phong_specular_directional.vsh",
                    "vertexLitMultiBlinnPhongSpecularDirectional");
