 ...
 */
public class BlinnPhongSpecularSpotTwoConeShader extends AbstractSpecularShader {

    public BlinnPhongSpecularSpotTwoConeShader(SpecularUniforms uniforms, Shader shader) {
    ...
    public static class Factory {
        ...
        public static BlinnPhongSpecularSpotTwoConeShader Create() throws IOException {
            Shader shader = Fw.graphics.buildShader(
                    "pixellit/single/blinn_phong_specular_spot_two_cone.fsh",
                    "pixellit/single/blinn_phong_specular_spot_two_cone.vsh",
