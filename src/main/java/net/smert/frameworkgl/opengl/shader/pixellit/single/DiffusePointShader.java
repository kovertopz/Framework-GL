 ...
 */
public class DiffusePointShader extends AbstractDiffuseShader {
    ...
    public static class Factory {
        ...
        public static DiffusePointShader Create() throws IOException {
            Shader shader = Fw.graphics.buildShader(
                    "pixellit/single/diffuse_point.fsh",
                    "pixellit/single/diffuse_point.vsh",
                    "pixelLitSingleDiffusePoint");
