...
public class BlinnPhongSpecularPoint extends AbstractShader {
    ...
    public BlinnPhongSpecularPoint(BlinnPhongSpecularUniforms uniforms, Shader shader) {
    ...
    public static class Factory {
        ...
        public static BlinnPhongSpecularPoint Create() throws IOException {
            ...
            return new BlinnPhongSpecularPoint(new BlinnPhongSpecularUniforms(shader.getProgramID()), shader);
        }
