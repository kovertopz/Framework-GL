 ...
 */
public class DiffuseDirectionalShader extends AbstractDiffuseShader {
    ...
    public static class Factory {
        ...
        public static DiffuseDirectionalShader Create() throws IOException {
            Shader shader = Fw.graphics.buildShader(
                    "pixellit/single/diffuse_directional.fsh",
                    "pixellit/single/diffuse_directional.vsh",
                    "pixelLitSingleDiffuseDirectional");
