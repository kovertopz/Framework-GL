 ...
 */
public class PhongSpecularDirectionalShader extends AbstractSpecularShader {
    ...
    public static class Factory {
        ...
        public static PhongSpecularDirectionalShader Create() throws IOException {
            Shader shader = Fw.graphics.buildShader(
                    "vertexlit/multi/phong_specular_directional.fsh",
                    "vertexlit/multi/phong_specular_directional.vsh",
                    "vertexLitMultiPhongSpecularDirectional");
