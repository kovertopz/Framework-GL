...
public class VertexBufferObjectNonInterleavedRenderable extends AbstractRenderable implements NonInterleavedRenderable {
    ...
    protected final VertexBufferObjectNonInterleavedData data;
    protected final VertexBufferObjectNonInterleavedRenderStrategy render;

    public VertexBufferObjectNonInterleavedRenderable(
            VertexBufferObjectNonInterleavedCreateStrategy create,
            VertexBufferObjectNonInterleavedRenderStrategy render) {
        this.create = create;
        this.data = new VertexBufferObjectNonInterleavedData();
        this.render = render;
