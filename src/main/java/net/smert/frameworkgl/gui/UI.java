...
public class UI {
    ...
    public static GuiControlBuilder controlBuiler;
    public static ClumsyGui gui;
    public static GuiFactory guiFactory;
    public static GuiImageBuilder imageBuilder;
    public static GuiLayerBuilder layerBuilder;
    public static GuiPanelBuilder panelBuilder;
    public static GuiScreenBuilder screenBuilder;
    public static GuiTextBuilder textBuilder;
