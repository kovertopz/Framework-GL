...
public class HashMapIntInt {
    ...
    public HashMapIntInt(int initialCapacity, float loadFactor) {
    ...
    private void addEntry(int hash, int key, int value, int bucketIndex) {
    ...
    public static class Entry {
        ...
        public Entry(int h, int k, int v, Entry n) {
            hash = h;
            key = k;
            value = v;
            next = n;
    ...
    private abstract class HashIterator<E> implements Iterator<E> {
        ...
        public void remove() {
            ...
            int k = current.key;
            current = null;
            HashMapIntInt.this.removeEntryForKey(k);
            expectedModCount = modCount;
        }
    ...
    private class KeySet extends AbstractSet<Integer> {
        ...
        public boolean remove(Object o) {
            ...
            return HashMapIntInt.this.removeEntryForKey((Integer) o) != null;
        }
