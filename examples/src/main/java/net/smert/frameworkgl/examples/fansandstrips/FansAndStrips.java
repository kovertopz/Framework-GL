 ...
 */
package net.smert.frameworkgl.examples.fansandstrips;
...
public class FansAndStrips extends Screen {
    ...
    public void init() {
        ...
        renderableFansAndStrips = Fw.graphics.getLegacyRenderer().createImmediateModeRenderable();
    ...
    public void render() {
        ...
        if (Fw.timer.isRenderTick()) {
            ...
            // Render directly
            Fw.graphics.getLegacyRenderer().render(renderableFansAndStrips, 0f, 0f, 0f);
        }
    }
