 ...
 */
package net.smert.frameworkgl.examples.gl3angelcodefont;
 ...
 */
public class AngelCodeFont extends Screen {
    ...
    private net.smert.frameworkgl.opengl.font.AngelCodeFont angelCodeFont;
    private AngelCodeFontRenderer angelCodeFontRenderer;
    ...
    public AngelCodeFont(String[] args) {
        renderAabbs = false;
