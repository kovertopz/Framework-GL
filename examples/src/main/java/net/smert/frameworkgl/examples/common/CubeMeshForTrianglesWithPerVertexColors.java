 ...
 */
public class CubeMeshForTrianglesWithPerVertexColors extends Mesh {

    public CubeMeshForTrianglesWithPerVertexColors() {
        super();
        addSegment();
    }
    ...
    private void addSegment() {
        ...
        GL.tessellator.stop();
        GL.tessellator.addSegment("Cube mesh for triangles with per vertex colors");
