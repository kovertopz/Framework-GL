 ...
 */
package net.smert.frameworkgl.examples.gl2displaylist;
 ...
 */
public class DisplayList extends Screen {
    ...
    public void init() {
        ...
        renderableQuads = GL.renderer2.createDisplayListRenderable();
        renderableQuads.create(meshQuads);
        renderableQuadsWithPerVertexColors = GL.renderer2.createDisplayListRenderable();
        renderableQuadsWithPerVertexColors.create(meshQuadsWithPerVertexColors);
        renderableTriangles = GL.renderer2.createDisplayListRenderable();
