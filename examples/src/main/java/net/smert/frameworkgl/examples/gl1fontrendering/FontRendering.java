 ...
 */
package net.smert.frameworkgl.examples.gl1fontrendering;
 ...
 */
public class FontRendering extends Screen {

    private final static Logger log = LoggerFactory.getLogger(FontRendering.class);
    ...
    public FontRendering(String[] args) {
        renderAabbs = false;
